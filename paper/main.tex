...
\begin{experiment}
Calculate $d(t)$, namely the TV distance between empirical pdf (using Gaussian kernel) and expected pdf for the following 5 density functions:
\begin{enumerate}
...
\end{experiment}
\begin{figure}
\includegraphics[.3\textwidth]{../../figure/sim3/case1_pdf.pdf}
\includegraphics[.3\textwidth]{../../figure/sim3/case1_l1.pdf}
\end{figure}
